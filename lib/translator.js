...
DebugTranslator.prototype.stepIn = function(steps, cb) { 
    cb = cb || function() {};
    this.client.continueScript("in", steps, callbackModifier(cb));
    return this;
};
...
DebugTranslator.prototype.stepOut = function(cb) {
    ...
    cb = cb || function() {};
    this.client.continueScript("out", 1, callbackModifier(cb));
    return this;
}

DebugTranslator.prototype.stepOver = function(steps, cb) {
    cb = cb || function() {};
    this.client.continueScript("next", steps, callbackModifier(cb));
    return this;
}
