...
var V8DebuggerService = require('v8debug').StandaloneV8DebuggerService;
var net = require('net');
...
DebugTranslator.prototype.evaluateGlobal = function(expression, cb) {
    cb = cb || function() {};
    this.client.evaluate(code, null, true, null, function(res, handles, err) {
        cb(err, res, handles);
    });
...
DebugTranslator.prototype.evaluateAtFrame = function(expression, frame, cb) {
    cb = cb || function() {};
    this.client.evaluate(code, frame, false, null, callbackModifier(cb));
...
DebugTranslator.prototype.backtrace = function(from, to, bottom, cb) {
    ...
    cb = cb || function() {};
    this.client.backtrace(from, to, bottom, null, callbackModifier(cb));
...
DebugTranslator.prototype.scripts = function(cb) {
    cb = cb || function() {};
    this.client.scripts(debug.NORMAL_SCRIPTS, null, true, callbackModifier(cb));
