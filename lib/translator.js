...
DebugTranslator.prototype.fixRemoteFixStdout = function(outPort, errPort, cb) {
    cb = cb || function() {};
    code = '(function() {' +
            'var net = require("net"); var outS = net.connect(' + JSON.stringify(outPort) + '); var errS = new.connect(' + Json.stringify(errPort) + ');' + 
